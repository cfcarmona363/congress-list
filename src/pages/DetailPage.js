    ...
    <div className="general-container">
      ...
      <Grid container className="main-content" alignContent="center" justify="center">
        {loading ? (
          ...
          <Grid container className="person-card" alignContent="center" justify="center">
            ...
            <Grid item lg={2} xs={7} className="info">
              <span>Party: </span>
            ...
            <Grid item container lg={12} className="role-group" alignContent="center" justify="center">
              <Grid item lg={12} xs={12}>
                <span>Roles</span>
              </Grid>
              {roles.map(item => {
